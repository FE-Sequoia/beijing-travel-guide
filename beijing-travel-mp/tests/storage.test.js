...
assert.strictEqual(toggleFavorite('food-donglaishun-wangfujing'), true, '美食 ID 应能与景点共用收藏存储');
assert.strictEqual(isFavorite('food-donglaishun-wangfujing'), true, '美食收藏应可被读取');
clearFavorites();
...
clearHistory();
recordHistory('food-donglaishun-wangfujing');
recordHistory('food-donglaishun-wangfujing');
assert.deepStrictEqual(getHistory(), ['food-donglaishun-wangfujing'], '美食浏览记录应去重并置顶');
clearHistory();
