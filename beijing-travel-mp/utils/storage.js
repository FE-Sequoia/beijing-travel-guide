...
function read(key) { try { return wx.getStorageSync(key) || []; } catch (e) { return []; } }
...
module.exports = { getFavorites, isFavorite, toggleFavorite, getHistory, recordHistory, clearHistory };
